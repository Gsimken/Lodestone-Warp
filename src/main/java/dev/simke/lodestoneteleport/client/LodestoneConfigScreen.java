		...
		ADVANCED("config.page.advanced", "Advanced") {
			...
			List<ConfigField> fields() {
				return List.of(
					...
					text("network_mode", "config.field.network_mode", "Network mode", "all", "Controls which Lodestones players can see and teleport to.", "all or discover.", () -> LodestoneConfig.get().networkMode, (config, value) -> config.networkMode = value),
